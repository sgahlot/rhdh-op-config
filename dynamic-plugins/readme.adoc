...
:uri-dynamic-plugin-starter-files: https://github.com/sgahlot/rhdh-op-config/tree/main/dynamic-plugins/frontend-wrapper-starter
...
To create a dynamic plugin support to a third-party frontend plugin, you'll need to either follow the steps given below or take the starter files from {uri-dynamic-plugin-starter-files}[Dynamic plugin starter files]:
